...
class MantenimientosControllerTest < ActionController::TestCase
  ...
  test "should create mantenimiento" do
    assert_difference('Mantenimiento.count') do
      post :create, mantenimiento: { costo: @mantenimiento.costo, fecha: @mantenimiento.fecha, kilometraje: @mantenimiento.kilometraje, observacion: @mantenimiento.observacion }
    end
  ...
  test "should update mantenimiento" do
    patch :update, id: @mantenimiento, mantenimiento: { costo: @mantenimiento.costo, fecha: @mantenimiento.fecha, kilometraje: @mantenimiento.kilometraje, observacion: @mantenimiento.observacion }
    assert_redirected_to mantenimiento_path(assigns(:mantenimiento))
  end
