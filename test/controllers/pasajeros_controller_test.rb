...
class PasajerosControllerTest < ActionController::TestCase
  ...
  test "should create pasajero" do
    assert_difference('Pasajero.count') do
      post :create, pasajero: { identidad: @pasajero.identidad, is_active: @pasajero.is_active, nombre: @pasajero.nombre }
    end
  ...
  test "should update pasajero" do
    patch :update, id: @pasajero, pasajero: { identidad: @pasajero.identidad, is_active: @pasajero.is_active, nombre: @pasajero.nombre }
    assert_redirected_to pasajero_path(assigns(:pasajero))
  end
