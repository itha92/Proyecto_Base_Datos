...
class AutobusesControllerTest < ActionController::TestCase
  ...
  test "should create autobus" do
    assert_difference('Autobus.count') do
      post :create, autobus: { capacidad: @autobus.capacidad, is_active: @autobus.is_active, marca: @autobus.marca, modelo: @autobus.modelo }
    end
  ...
  test "should update autobus" do
    patch :update, id: @autobus, autobus: { capacidad: @autobus.capacidad, is_active: @autobus.is_active, marca: @autobus.marca, modelo: @autobus.modelo }
    assert_redirected_to autobus_path(assigns(:autobus))
  end
