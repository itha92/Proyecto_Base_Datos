...
class AsientosControllerTest < ActionController::TestCase
  ...
  test "should create asiento" do
    assert_difference('Asiento.count') do
      post :create, asiento: { asiento_no: @asiento.asiento_no, is_active: @asiento.is_active, tipo: @asiento.tipo }
    end
  ...
  test "should update asiento" do
    patch :update, id: @asiento, asiento: { asiento_no: @asiento.asiento_no, is_active: @asiento.is_active, tipo: @asiento.tipo }
    assert_redirected_to asiento_path(assigns(:asiento))
  end
